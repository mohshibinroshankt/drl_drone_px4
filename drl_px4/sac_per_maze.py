...
class PrioritizedReplayBuffer(ReplayBuffer):
    def __init__(
        ...
        beta_increment: float = 1e-3,  # Increased for faster beta increase
    ):
        super().__init__(
            buffer_size,
            observation_space,
...
class SAC_PER(SAC):
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        # Increase gradient steps per timestep
    ...
    def _compute_actor_loss(self, obs):
        ...
        # Ensure log_prob and q_values are compatible shapes
        ...
        loss = -(q_values - entropy_term).mean()  # SAC actor loss: maximize Q - entropy
